...
- La tipografia exacta aun no esta definida. Hasta que se decida, usar una sans-serif legible del sistema y no introducir fuentes externas por cuenta propia.
